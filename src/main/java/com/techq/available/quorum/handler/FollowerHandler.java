...
import com.techq.available.quorum.Type;
...
public class FollowerHandler {
	private static final Logger LOG = LoggerFactory.getLogger(FollowerHandler.class);
	...
	PINGWorker worker;
	static FollowerHandler instance = null;
	...
	public FollowerHandler(long leaderId, long xid, long myId, InetSocketAddress addr) throws IOException, InterruptedException {
		super();
